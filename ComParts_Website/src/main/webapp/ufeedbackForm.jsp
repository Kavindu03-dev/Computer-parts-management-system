            ...
            <div class="container">
                ...
                <div class="contactForm">
                    <form action="Contactservlet2" method="post"  >
                        ...
                        <div class="inputBox">
                            <input type="text" name="fullname" id="fullname" value="${feedbackdetails.name}" required="required">
                            <span>New Full Name(If needed)</span>
                        </div>

                        <div class="inputBox">
                            <input type="text" name="email" id="email" value="${feedbackdetails.email}" required="required">
                            <span>New Email(If needed)</span>
                        </div>
                        
                        
                        <div class="inputBox">
                        
                            <input type="text" name="feedback" id="msg" value="${feedbackdetails.feedback}" required="required" >
                            <span>Type New Feedback...</span><br>
