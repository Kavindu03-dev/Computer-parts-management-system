...
<body>
		...
		<form action="Contactservlet2" method="post"  >
                        ...
                        <div class="inputBox">
                        <span>ID</span><br>
                        <input type="text" name="fid" id="fid" value="<%=id %>" readonly>
                        ...
                        <div class="inputBox">
                            <input type="text" name="email" id="email" value="<%=email %>" required="required">
                        ...
                        <div class="inputBox">
                            ...
                            <input type="text" name="msg" id="msg" value="<%=feedback %>" required="required" >
